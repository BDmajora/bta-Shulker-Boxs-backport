...
public class RecipeShulkerBoxJsonAdapter implements RecipeJsonAdapter<RecipeEntryShulkerBox> {
    @Override
    public RecipeEntryShulkerBox deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
    ...
    @Override
    public JsonElement serialize(RecipeEntryShulkerBox src, Type typeOfSrc, JsonSerializationContext context) {
    ...
    public static RecipeEntryShulkerBox parseRecipe(List<String> pattern, List<RecipeSymbol> symbols, ItemStack result, boolean consumeContainerItem) {
    ...
    public static RecipeEntryShulkerBox parseRecipe(ItemStack itemstack, boolean consumeContainerItem, Object ... aobj) {
        ...
        return new RecipeEntryShulkerBox(j, k, symbols, itemstack, consumeContainerItem);
    }
}
