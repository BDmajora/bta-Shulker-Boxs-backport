...
public class ItemShulkerBoxInventory implements IInventory {
    private final ItemStack stack;
    protected ItemStack[] backpackItemStacks;
    public ItemShulkerBoxInventory(ItemStack stack){
        assert stack.getItem() instanceof ItemShulkerBox;
        this.stack = stack;
        ItemShulkerBox itemBackpack = (ItemShulkerBox) stack.getItem();
    ...
    public void onInventoryChanged() {
        ...
        if (!Global.isServer) {
            ShulkerBoxClient.sendStackUpdate(stack.getData());
        }
    ...
    public boolean canInteractWith(EntityPlayer entityPlayer) {
        if (!ShulkerBoxBackport.ENABLE_BACKPACKS){
            return false;
        }
