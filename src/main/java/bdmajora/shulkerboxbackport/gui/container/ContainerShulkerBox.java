package bdmajora.shulkerboxbackport.gui.container;
...
import bdmajora.shulkerboxbackport.gui.slots.SlotShulkerBox;
...
public class ContainerShulkerBox extends Container {
    ...
    public ItemShulkerBoxInventory backpackInventory;
    public ContainerShulkerBox(InventoryPlayer playerInv, ItemStack backpack){
        this.playerInv = playerInv;
        this.backpack = backpack;
        this.backpackInventory = new ItemShulkerBoxInventory(backpack);
        ...
        for (int i = 0; i < rows; ++i) {
            ...
            for (int k = 0; k < width; ++k) {
                this.addSlot(new SlotShulkerBox(backpackInventory, k + i * 9, 8 + k * 18, 18 + 18 * i));
            }
        }
        for (int i = 0; i < 3; ++i) {
            for (int k = 0; k < 9; ++k) {
